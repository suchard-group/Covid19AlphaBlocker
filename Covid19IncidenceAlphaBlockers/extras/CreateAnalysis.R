...
htnIngredientConceptAltIds <- c(
  aceConceptIds, arbConceptIds, thzConceptIds, ccbConceptIds, bbConceptIds, ndCcbConceptIds
)
...
# Check how the two sets of HTN ingredients differ
setdiff(htnIngredientConceptIds, htnIngredientConceptAltIds)
setdiff(htnIngredientConceptAltIds, htnIngredientConceptIds)
